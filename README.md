...
![The Remix Remix App](./public/remix-app.png)
...
The Remix App is a starter template for SaaS apps in general, but also
...
By default, MSW is used in the Remix App to mock requests to Magic in
...
The Remix App uses [Magic](https://magic.link/) for authentication with a custom session
...
In addition to the components from ShadcnUI, the Remix App comes with
...
The Remix App comes with localization support through
...
The Remix App comes with error reporting using Sentry build in.
...
The Remix App includes utilities for toast notifications based on flash sessions.
...
The Remix App comes with a SQLite database out of the box. It uses
...
The Remix App comes with a magic link setup via email preconfigured.
